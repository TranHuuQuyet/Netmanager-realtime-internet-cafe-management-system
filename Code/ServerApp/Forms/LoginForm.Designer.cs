...
partial class LoginForm
{
    ...
    private void InitializeComponent()
    {
        ...
        loginPanel.Controls.Add(buttonPanel, 0, 3);
        loginPanel.Controls.Add(lblMessage, 0, 4);
        loginPanel.Dock = DockStyle.Fill;
        loginPanel.Location = new Point(24, 24);
        loginPanel.Name = "loginPanel";
        loginPanel.RowCount = 5;
        ...
        buttonPanel.Location = new Point(3, 149);
        ...
        lblMessage.Location = new Point(3, 200);
        lblMessage.Name = "lblMessage";
        lblMessage.Size = new Size(370, 2);
